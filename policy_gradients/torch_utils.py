...
class Trajectories:
    def __init__(self, states=None, rewards=None, returns=None, not_dones=None,
                 ...
                 unrolled=False, values=None, condition_q = None):
        ...
        if states is not None:
            ...
            #assert condition_q is None or condition_q.shape[0] == num_saps
    ...
    def tensor_op(self, lam, should_wrap=True):
        ...
        #condition_q = op(self.condition_q)
